  ...
  return (
    <div className="flex flex-col h-screen select-none"
      ...
      <div className="h-8 flex items-center px-3 gap-2 shrink-0"
        style={{
          background: 'linear-gradient(180deg, #227a4b 0%, #1a6b3f 100%)',
        ...
        <span className="text-white/95 text-[11px] font-medium tracking-wide">
          Excellusion
        </span>
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="flex-1 flex flex-col overflow-hidden">
          {!client ? (
            ...
            <HybridSheet client={client} onLog={addLog} />
          )}
        </div>
        <div style={{ width: 360, borderLeft: '1px solid #ccc' }} className="shrink-0">
          <LogPane entries={logs} mode="hybrid" />
        </div>
      </div>
    </div>
  )
